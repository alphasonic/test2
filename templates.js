app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/directives/profil-auth.html',
    "<div class=\"btn-group btn-group-justified space-full\" ng-hide=isAuth()><a class=\"btn btn-rounded\" ng-click=displayAuth()>S'identifier</a></div><div class=\"btn-group btn-group-justified space-hz\" ng-hide=isAuth()><a class=\"btn btn-rounded\" ng-click=displaySave()>Sauvegarder ses données</a></div><div class=\"btn-group btn-group-justified space-full\" ng-show=isAuth()><a class=\"btn btn-rounded\" ng-click=signout()><i class=\"fa fa-sign-out\"></i> Se déconnecter</a></div><div ng-show=authShow class=fixed-full><div class=space-full><div class=form-group><div class=row><input name=phone_num ng-model=phoneNum placeholder=\"Numéro de téléphone\" required></div><div class=row><input type=password id=password ng-model=password placeholder=\"Mot de passe\"></div></div></div><div class=\"btn-group btn-group-justified space-hz\"><a class=\"btn btn-rounded\" ng-click=auth()>S'identifier</a> <a class=\"btn btn-rounded\" ng-click=cancel()>Annuler</a></div></div><div ng-show=saveShow class=fixed-full><div class=space-full><div class=form-group><div class=row><input type=password id=password ng-model=passwordSave placeholder=\"Mot de passe\"></div></div></div><div class=\"btn-group btn-group-justified space-hz\"><a class=\"btn btn-rounded\" ng-click=save()>Sauvegarder</a> <a class=\"btn btn-rounded\" ng-click=cancel()>Annuler</a></div></div>"
  );
