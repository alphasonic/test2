app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/carte-category-list.html',
    "<div id=carte-category-list ng-controller=CarteCategoryListCtrl><div class=header><div class=nav-left><a ng-click=showMenu()><i class=\"fa fa-bars fa-22px\"></i></a></div><div class=title>CARTE</div></div><div image-rotor=\"\" image-url=imageUrl><a class=img-click ng-click=displayProductList(selectedElement)></a></div><div class=category-list ng-iscroll=wrapper ng-model=selectedElement><div id=scroller><ul class=listview><li ng-repeat=\"cat in categories | orderBy:cat.NUM_ORDER\" id={{cat.CATEGORY_ID}} last-repeat=\"\"><a ng-click=displayProductList(cat.CATEGORY_ID)><div class=row><div class=col-right-icon><i class=\"fa fa-chevron-right\"></i></div><div class=\"col100 has-right-icon\">{{cat.NAME}}</div></div></a></li></ul><div class=gap></div></div></div></div>"
  );


  $templateCache.put('views/carte-product-list.html',
    "<div id=carte-product-list ng-controller=CarteProductListCtrl><div class=header><div class=nav-left><a ng-click=backToCategory()><i class=\"fa fa-arrow-left fa-22px\"></i></a></div><div class=title>{{categoryTitle}}</div></div><div image-rotor=\"\" image-url=imageUrl><a class=img-click ng-click=displayProduct(selectedElement)></a><div class=product-order><div order-counter=\"\" element=selectedProduct><a ng-click=goToOrder()><i class=\"fa fa-shopping-cart fa-30px\"></i></a></div></div></div><div class=product-list ng-iscroll=wrapper ng-model=selectedElement><div id=scroller><ul class=listview><li ng-repeat=\"prod in products | orderBy:'NUM_ORDER'\" id={{prod.PRODUCT_ID}} last-repeat=\"\"><a ng-click=displayProduct(prod.PRODUCT_ID)><div class=row><div class=col-right-icon><i class=\"fa fa-chevron-right\"></i></div><div class=bubble><span ng-hide=\"getQuantity(prod.PRODUCT_ID)==0\">{{getQuantity(prod.PRODUCT_ID)}}</span></div><div class=\"col100 has-2-right-icon\"><div product-description=\"\" product=prod></div></div></div></a></li></ul><div class=gap></div></div></div></div>"
  );


  $templateCache.put('views/carte-product.html',
    "<div id=carte-product ng-controller=CarteProductCtrl><div class=header><div class=nav-left><a ng-click=back()><i class=\"fa fa-arrow-left fa-22px\"></i></a></div><div class=title>Carte</div></div><div image-rotor=\"\" image-url=imageUrl></div><div class=product-description><div id=title><ul class=listview><li><div class=row><a><div product-description=\"\" product=product></div></a></div></li></ul><p>{{product.DESCRIPTION}}</p></div><div id=description></div><div class=product-order><div order-counter=\"\" element=product><a ng-click=toogleFavorite()><i ng-hide=isFavorite() class=\"fa fa-heart-o fa-40px\"></i> <i ng-show=isFavorite() class=\"fa fa-heart fa-40px\"></i></a><a ng-click=goToOrder()><i class=\"fa fa-shopping-cart fa-40px\"></i></a></div></div></div></div>"
  );
  ...
  $templateCache.put('views/favorite-list.html',
    "<div class=favorite-list ng-controller=FavoriteListCtrl><div class=header><div class=nav-left><a ng-click=showMenu()><i class=\"fa fa-bars fa-22px\"></i></a></div><div class=title>FAVORIS</div></div><div class=favorite-empty ng-show=isFavoriteEmpty()><i class=\"fa fa-heart-o fa-4x\"></i><p>Vous n'avez pas de favoris</p></div><div ng-hide=isFavoriteEmpty()><div image-rotor=\"\" image-url=imageUrl><div class=product-order><div order-counter=\"\" element=selectedProduct><a ng-click=goToOrder()><i class=\"fa fa-shopping-cart fa-30px\"></i></a></div></div></div><div class=product-list ng-iscroll=wrapper ng-model=selectedElement><div id=scroller><ul class=listview><li ng-repeat=\"prod in products\" id={{prod.PRODUCT_ID}} last-repeat=\"\"><a ng-click=displayProduct(prod.PRODUCT_ID)><div class=row><div class=col-right-icon><i class=\"fa fa-chevron-right\"></i></div><div class=bubble><span ng-hide=\"getQuantity(prod.PRODUCT_ID)==0\">{{getQuantity(prod.PRODUCT_ID)}}</span></div><div class=\"col100 has-2-right-icon\"><div product-description=\"\" product=prod></div></div></div></a></li></ul><div class=gap></div></div></div></div></div>"
  );


  $templateCache.put('views/login.html',
    "<div ng-controller=LoginCtrl><div class=header><div class=nav-left><a ng-click=showMenu()><i class=\"fa fa-bars fa-22px\"></i></a></div><div class=title>Login</div></div><div class=space-full><form name=signup><div class=form-group><div class=row><input name=phone_num ng-model=profil.PHONE_NUM placeholder=\"Numéro de téléphone\" required><span class=error ng-show=signup.phone_num.$error.required>Le numéro de téléphone est obligatoire.</span><span class=error ng-show=\"signup.phone_num.$error.min || signup.phone_num.$error.max || signup.phone_num.$error.integer\">Le numéro de téléphone est invalide</span></div><div class=row><input type=password id=password ng-model=profil.PASSWORD placeholder=\"Mot de passe\"></div><div class=row ng-show=newUser><input type=password id=confirm-password ng-model=confirmPwd placeholder=\"Confirmer Mot de passe\"></div><div class=row><label class=topcoat-checkbox><input type=checkbox id=new-user ng-model=newUser><div class=topcoat-checkbox__checkmark></div>Je suis nouveau</label></div></div></form></div><div class=space-hz><a class=\"btn btn-rounded\" ng-click=login()><span ng-hide=newUser><i class=\"fa fa-sign-in\"></i> Login</span><span ng-show=newUser>Créer mon profil</span></a></div></div>"
  );


  $templateCache.put('views/menu.html',
    "<div class=main-menu ng-controller=MenuCtrl><div><a class=menu-carte ng-click=\"changePage('carte-category-list.html')\"></a></div><div><a class=menu-favoris ng-click=\"changePage('favorite-list.html')\"></a></div><div><a class=menu-commande ng-click=\"changePage('order-step1.html')\"></a></div><div><a class=menu-boutiques ng-click=\"changePage('shop-list.html')\"></a></div><div><a class=menu-profil ng-click=\"changePage('profil.html')\"></a></div><div ng-hide=pageEmpty()><a class=menu-closer ng-click=closeMenu()></a></div></div>"
  );
  ...
  $templateCache.put('views/order-step2.html',
    "<div ng-controller=OrderStep2Ctrl><div class=header><div class=nav-left><a ng-click=backToStep1()><i class=\"fa fa-arrow-left fa-22px\"></i></a></div><div class=title>COMMANDE</div></div><div class=btn-group-tab><a class=btn ng-click=setDelivery(true)><span class=tab-btn ng-class=\"{'active': isDelivery}\"><i class=\"fa fa-truck\"></i> Livraison</span></a><a class=btn ng-click=setDelivery(false)><span class=tab-btn ng-class=\"{'active': !isDelivery}\"><i class=\"fa fa-home\"></i> A emporter</span></a></div><div class=animate-show-container><div ng-show=isDelivery class=animate-hide><div class=space-full><a class=\"btn btn-invert\" ng-click=pickProfilAddress()><div ng-show=\"selectedProfilAddress==null\">Choisissez votre addresse</div><div ng-hide=\"selectedProfilAddress==null\"><div ng-hide=isStreetName2Null(selectedProfilAddress)>{{selectedProfilAddress.STREET_NAME2}}</div><div>{{selectedProfilAddress.STREET_NAME}} {{selectedProfilAddress.STREET_NB}} {{selectedProfilAddress.BELL}}</div><div>{{selectedProfilAddress.POSTCODE}} {{selectedProfilAddress.CITY}}</div></div></a><div class=space-vt><a ng-show=isDeliveryStepOk() class=\"btn btn-rounded\" ng-click=gotoStep3()>Suivant <i class=\"fa fa-chevron-right\"></i></a></div></div></div><div ng-hide=isDelivery class=animate-show><div class=space-full><a class=\"btn btn-invert\" ng-click=pickShopAddress()><div ng-show=\"selectedShop==null\">Choisissez un magasin</div><div ng-hide=\"selectedShop==null\"><div>{{selectedShop.NAME}}</div><div ng-hide=isStreetName2Null(selectedShop.address)>{{selectedShop.address.STREET_NAME2}}</div><div>{{selectedShop.address.STREET_NAME}} {{selectedShop.address.STREET_NB}} {{selectedShop.address.BELL}}</div><div>{{selectedShop.address.POSTCODE}} {{selectedShop.address.CITY}}</div></div></a><div class=space-vt><a ng-show=isTakeAwayStepOk() class=\"btn btn-rounded\" ng-click=gotoStep3()>Suivant <i class=\"fa fa-chevron-right\"></i></a></div></div></div></div></div>"
  );
  ...
  $templateCache.put('views/pick-profil-address.html',
    "<div ng-controller=PickProfilAddressCtrl><h3>Choisissez une adresse :</h3><ul class=listview><li ng-repeat=\"address in addresses\"><div class=row><div class=\"col100 has-right-icon\"><a ng-click=selectAddress(address)><div ng-hide=isStreetName2Null(address)>{{address.STREET_NAME2}}</div><div>{{address.STREET_NAME}} {{address.STREET_NB}} {{address.BELL}}</div><div>{{address.POSTCODE}} {{address.CITY}}</div><div ng-hide=isDelivered(address)>Cette addresse n'est pas déservie</div></a></div><div class=col-right-icon><a ng-click=removeAddress(address.ADDRESS_ID)><i class=\"fa fa-times\"></i></a></div></div></li></ul><div class=\"btn-group btn-group-justified space-full\"><a class=\"btn btn-rounded\" ng-click=displayUpdateAddress(null)><i class=\"fa fa-plus\"></i> Ajouter une adresse</a><a class=\"btn btn-rounded\" ng-click=close()><i class=\"fa fa-times\"></i> Annuler</a></div></div>"
  );


  $templateCache.put('views/pick-shop.html',
    "<div ng-controller=PickShopAddressCtrl><h3>Choisissez une adresse :</h3><ul class=listview><li ng-repeat=\"shop in shops\"><div class=row><a ng-click=selectAddress(shop)><div>{{shop.NAME}}</div><div ng-hide=isStreetName2Null(shop.address)>{{shop.address.STREET_NAME2}}</div><div>{{shop.address.STREET_NAME}} {{shop.address.STREET_NB}} {{shop.address.BELL}}</div><div>{{shop.address.POSTCODE}} {{shop.address.CITY}}</div></a></div></li></ul></div>"
  );


  $templateCache.put('views/profil-update-address.html',
    "<div ng-controller=ProfilUpdateAddressCtrl id=profil-update-address><form class=form-horizontal role=form><div class=space-full ng-show=seachVisible><div class=form-group><div class=row><div class=input-icon><div class=icon><i class=\"fa fa-search fa-22px\"></i></div><div class=custom-input><input id=google-search placeholder=Rue></div></div></div></div></div><div class=space-full><div class=form-group><div class=row><input class=form-control id=street-name2 ng-model=address.STREET_NAME2 placeholder=\"Nom du batiment, voisinage, quartier... (optionnel)\"></div><div class=row><input class=form-control id=street-name ng-model=address.STREET_NAME placeholder=Rue></div><div class=row><input class=form-control id=street-nb ng-model=address.STREET_NB placeholder=Numéro></div><div class=row><input class=form-control id=bell ng-model=address.BELL placeholder=Sonnette></div><div class=row><input class=form-control id=postcode ng-model=address.POSTCODE placeholder=\"Code postal\" ng-change=refreshCity(true)></div><div class=row><div class=styled-select><select ng-model=address.CITY name=city id=city ng-options=\"elt.CITY for elt in cityList\"></select></div></div></div></div><div class=\"space-hz btn-group\"><a class=\"btn btn-rounded\" ng-click=validAddress()><i class=\"fa fa-check\"></i> <span ng-show=\"address.ADDRESS_ID==null\">Créer</span><span ng-hide=\"address.ADDRESS_ID==null\">Modifier</span></a> <a class=\"btn btn-rounded\" ng-click=close()><i class=\"fa fa-times\"></i> Annuler</a></div></form></div>"
  );


  $templateCache.put('views/profil-update-password.html',
    "<div ng-controller=ProfilUpdatePasswordCtrl><form class=form-horizontal name=form><div class=space-full><div class=form-group><div class=row><input type=password id=old-password ng-model=password.OLDPWD placeholder=\"Ancien Mot de passe\"></div><div class=row><input type=password name=newPassword id=new-password ng-model=password.NEWPWD placeholder=\"Nouveau mot de passe\" ng-minlength=5><span class=error ng-show=form.newPassword.$error.minlength>Mot de passe trop court</span><br></div><div class=row><input type=password id=confirm-password ng-model=password.CONFIRMPWD placeholder=\"Confirmer mot de passe\"></div></div></div><div class=\"space-hz btn-group\"><a class=\"btn btn-rounded\" ng-click=validPassword()><i class=\"fa fa-check\"></i> Modifier</a><a class=\"btn btn-rounded\" ng-click=close()><i class=\"fa fa-times\"></i> Annuler</a></div></form></div>"
  );


  $templateCache.put('views/profil-update.html',
    "<div ng-controller=ProfilUpdateCtrl class=space-top><form class=form-horizontal role=form><div class=space-full><div class=form-group><div class=row><input class=form-control id=prenom ng-model=profil.PRENOM placeholder=Prénom></div><div class=row><input class=form-control id=nom ng-model=profil.NOM placeholder=Nom></div><div class=row><input class=form-control id=prenom ng-model=profil.EMAIL placeholder=E-mail></div><div class=row><input class=form-control id=prenom ng-model=profil.PHONE_NUM placeholder=\"N° de téléphone\"></div></div></div><div class=\"space-hz btn-group\"><a class=\"btn btn-rounded\" ng-click=validProfil()><i class=\"fa fa-check\"></i> Modifier</a> <a class=\"btn btn-rounded\" ng-click=close()><i class=\"fa fa-times\"></i> Annuler</a></div></form></div>"
  );


  $templateCache.put('views/profil.html',
    "<div ng-controller=ProfilCtrl><div class=header><div class=nav-left><a ng-click=showMenu()><i class=\"fa fa-bars fa-22px\"></i></a></div><div class=title>PROFIL</div></div><ul class=listview><li><a ng-click=displayUpdateProfil()><div class=row><div class=col-right-icon><i class=\"fa fa-edit\"></i></div><div class=\"col100 has-right-icon\"><div class=col1>Nom:</div><div class=col2>{{profil.PRENOM}} {{profil.NOM}}</div><div class=col1>E-mail:</div><div class=col2>{{profil.EMAIL}}</div><div class=col1>Telephone:</div><div class=col2>{{profil.PHONE_NUM}}</div></div></div></a></li><li><a ng-click=displayUpdatePassword()><div class=row><div class=col-right-icon><i class=\"fa fa-edit\"></i></div><div class=\"col100 has-right-icon\"><div class=col1>Mot de passe:</div><div class=col2>**********</div></div></div></a></li></ul><h3>Adresses :</h3><ul class=listview><li ng-repeat=\"address in profil.addresses\"><div class=row><div class=col-right-icon><a ng-click=removeAddress(address.ADDRESS_ID)><i class=\"fa fa-times\"></i></a></div><div class=\"col100 has-right-icon\"><a ng-click=displayUpdateAddress(address)><div ng-hide=isStreetName2Null(address)>{{address.STREET_NAME2}}</div><div>{{address.STREET_NAME}} {{address.STREET_NB}} {{address.BELL}}</div><div>{{address.POSTCODE}} {{address.CITY}}</div></a></div></div></li></ul><div class=\"btn-group btn-group-justified space-full\"><a class=\"btn btn-rounded\" ng-click=displayUpdateAddress(null)><i class=\"fa fa-plus\"></i> Ajouter une adresse</a></div></div>"
  );
