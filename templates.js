app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/carte.html',
    "<div id=carte ng-controller=CarteCtrl><div class=page-swipe page-swipe=pageIndex lock=false scroll-end=scrollEnd><div id=pageScroller><div class=page><div ng-include=\"'views/carte-category-list.html'\"></div></div><div class=page><div ng-include=\"'views/carte-product-list.html'\"></div></div><div class=page><div ng-include=\"'views/carte-product.html'\"></div></div></div></div></div>"
  );
  ...
  $templateCache.put('views/order.html',
    "<div id=order ng-controller=OrderCtrl><div class=page-swipe page-swipe=pageIndex scroll-end=scrollEnd><div id=pageScroller><div class=page><div ng-include=\"'views/order-step1.html'\"></div></div><div class=page><div ng-include=\"'views/order-step2.html'\"></div></div><div class=page><div ng-include=\"'views/order-step3.html'\"></div></div><div class=page><div ng-include=\"'views/order-step4.html'\"></div></div></div></div></div>"
  );
  ...
  $templateCache.put('views/shop.html',
    "<div id=carte ng-controller=ShopCtrl><div class=page-swipe page-swipe=pageIndex scroll-end=scrollEnd><div id=pageScroller><div class=page><div ng-include=\"'views/shop-list.html'\"></div></div><div class=page><div ng-include=\"'views/shop-details.html'\"></div></div></div></div></div>"
  );
}]);