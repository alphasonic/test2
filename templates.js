app.run(['$templateCache', function($templateCache){  'use strict';
  ...
  $templateCache.put('views/directives/profil-auth.html',
    "<div class=\"btn-group btn-group-justified space-hz\" ng-hide=isAuth()><a class=\"btn btn-rounded\" ng-click=displayAuth()>S'identifier</a></div><div class=\"btn-group btn-group-justified space-full\" ng-hide=isAuth()><a class=\"btn btn-rounded\" ng-click=displaySave()>Sauvegarder ses données</a></div><div class=\"btn-group btn-group-justified space-hz\" ng-show=isAuth()><a class=\"btn btn-rounded\" ng-click=signout()><i class=\"fa fa-sign-out\"></i> Se déconnecter</a></div>"
  );
